...
RUN_MODE = 'resume';          % 'train' | 'resume' | 'test'
PPO_CONFIG = 'A';            % [IMPROVED] 'A'->; 'B': horizon più lungo, convergenza migliore
...
if strcmp(RUN_MODE, 'test')
    ...
    trainOpts = rlTrainingOptions( ...
        MaxEpisodes              = 20000, ...
        MaxStepsPerEpisode       = 3000, ...   % [IMPROVED] 1500->3000: episodi più lunghi
        Plots                    = 'training-progress', ...
        Verbose                  = true, ... %%VerboseFrequency         = 50, ...
        StopTrainingCriteria     = 'AverageReward', ...
        StopTrainingValue        = 7000, ...   % [IMPROVED] 30000->7000: target realistico
        ScoreAveragingWindowLength = 100, ...
        SaveAgentCriteria        = 'EpisodeReward', ...
        SaveAgentValue           = 4000, ...   % [IMPROVED] 10000->4000: salva prima
